...
function TruthOrDareClassicChoice({ doerName, onChoice, truthDisabled, dareDisabled }) {
  return (
    <div className="text-center my-6 p-8 bg-gray-700 rounded-lg shadow-lg">
      <p className="text-2xl font-semibold text-blue-400 mb-6">{doerName}, it's your turn!</p>
      <p className="text-lg text-gray-200 mb-6">Choose your fate:</p>
      ...
      className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-lg text-lg disabled:opacity-50"
